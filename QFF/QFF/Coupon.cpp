...
namespace qff {
Coupon::Coupon(double notional, const string& currencyCode, date paymentDate,
...
string Coupon::getCurrency() const { return currencyCode_; }

date Coupon::getPaymentDate() const { return paymentDate_; }
