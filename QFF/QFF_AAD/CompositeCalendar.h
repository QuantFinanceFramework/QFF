...
namespace qff_a {
class CompositeCalendar final : public BaseCalendar {
 public:
  explicit CompositeCalendar(
      std::vector<std::unique_ptr<ICalendar>> calendar_list);

  template <typename... Ts>
  explicit CompositeCalendar(Ts&&... calendars)
    : calendar_list_(sizeof...(calendars)) {
